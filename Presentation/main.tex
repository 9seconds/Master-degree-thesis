...
\begin{frame}
	\frametitle{Синтез оптимального управления}
	\framesubtitle{Уравнение Беллмана при $T \to \infty$}\small
...
\begin{frame}
	...
	\framesubtitle{Постановка задачи}\small
    
    Пусть система задана в виде процесса Ито~\ref{eq:11}

    \begin{equation}\label{eq:11}
    	d\mathbf{x}_t = \mathbf{a}(\mathbf{x}_t, \mathbf{u}, t)dt + \mathbf{C}(\mathbf{x}_t, \mathbf{u}, t)d\mathbf{f}_t \text{.}
    \end{equation}
