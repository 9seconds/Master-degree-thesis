...
% начало рисунка
\newcommand{\bfig}[1]{ \begin{figure}\lbl{#1} \addtocounter{figure_counter}{1} }

% конец рисунка
\newcommand{\efig}{ \end{figure} }

% подпись в рисунке
\newcommand{\figlabel}[1]{ \begin{center} \emph{Рис \arabic{figure_counter}. #1} \end{center} }

% вставка рисунка
\newcommand{\addfigure}[3]{ \bfig{#1} \input{fig_#2} \figlabel{#3} \efig }
